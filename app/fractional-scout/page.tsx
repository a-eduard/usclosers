...
export default function FractionalScoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/fractional-sdr-leads', { // Using same endpoint or update as needed
        method: 'POST',
      ...
      if (res.ok) {
        if (typeof window !== 'undefined' && (window as any).gtag) {
          (window as any).gtag('event', 'fractional_scout_lead_submit', {
            event_category: 'form',
            event_label: 'fractional_scout'
          });
        }
    ...
    <div className="bg-background-primary min-h-screen text-text-primary font-sans selection:bg-purple-100 dark:selection:bg-purple-500/30 transition-theme">
      ...
      <section className="relative pt-24 pb-16 sm:pt-32 sm:pb-24 lg:pt-40 lg:pb-32 overflow-hidden bg-background-secondary transition-theme border-b border-border-primary">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
          <div className="absolute top-1/4 right-1/4 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-purple-200/50 dark:bg-purple-600/10 rounded-full blur-[80px] sm:blur-[120px]"></div>
          <div className="absolute top-1/3 left-1/4 w-[250px] sm:w-[400px] h-[250px] sm:h-[400px] bg-indigo-200/50 dark:bg-indigo-600/10 rounded-full blur-[80px] sm:blur-[120px]"></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center flex-col-reverse lg:flex-row">
            ...
            >
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4 sm:mb-6 leading-[1.1] text-text-primary transition-theme">
                Harvests buyer contacts, enriches CRM, and runs <br className="hidden sm:block"/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-500 dark:from-purple-400 dark:to-indigo-400">initial lead qualification.</span>
              </h1>
              <p className="text-base sm:text-lg md:text-xl text-text-secondary mb-8 sm:mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-medium transition-theme">
                Zero costs for tech stack and training. A qualified part-time Scout generates leads, scrapes databases, sets up domains, and warms up emails from day one. You pay only for actual lead generation hours.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
                ...
                >
                  Hire a Scout <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5" />
                </a>
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-tr from-purple-200 to-indigo-100 dark:from-purple-600/20 dark:to-indigo-500/20 rounded-3xl blur-[60px] md:blur-[80px] transform -rotate-6 opacity-60 dark:opacity-100 transition-theme pointer-events-none"></div>
              ...
              <div className="relative rounded-2xl md:rounded-3xl overflow-hidden border border-purple-100/50 dark:border-purple-500/20 bg-background-primary/50 backdrop-blur-sm shadow-2xl shadow-purple-600/20 dark:shadow-purple-500/10 p-1.5 sm:p-2 transition-theme z-10">
                <div className="rounded-xl md:rounded-2xl overflow-hidden relative border border-border-primary aspect-[4/3] sm:aspect-auto sm:h-[350px] lg:h-[450px] transition-theme bg-background-secondary">
                  <Image 
                    src={scoutHeroImg} 
                    alt="Fractional Scout Dashboard" 
                    fill
                    priority
                    quality={85}
      ...
      <section className="py-16 md:py-24 bg-background-primary border-t border-border-primary transition-theme">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 sm:mb-6 text-text-primary transition-theme">The True Cost of Full-Time Scouts</h2>
            <p className="text-text-secondary text-base sm:text-lg font-medium transition-theme">Why hiring an in-house Junior Scout for a startup is a financial trap.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={i} className="bg-background-secondary p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-border-primary flex flex-col h-full hover:shadow-xl hover:border-rose-500/30 transition-all duration-300 group">
                ...
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <span className="text-[10px] font-extrabold text-rose-600 dark:text-rose-400 uppercase tracking-widest bg-rose-50 dark:bg-rose-500/10 px-2.5 py-1 rounded-full border border-rose-100 dark:border-transparent transition-theme">{Pain.tag}</span>
                </div>
      ...
      <section className="py-16 md:py-24 bg-background-secondary relative overflow-hidden transition-theme border-t border-border-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 sm:mb-6 text-text-primary transition-theme">How the Fractional Scout Loop Works</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-5xl mx-auto mb-12 sm:mb-16">
            {[
              ...
              <div key={i} className="bg-background-primary/80 backdrop-blur-sm border border-border-primary p-6 sm:p-8 rounded-2xl sm:rounded-3xl flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-6 sm:gap-8 hover:shadow-xl hover:border-purple-500/30 transition-all duration-300 group">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/40 dark:to-indigo-900/40 bg-background-secondary border border-purple-100 dark:border-purple-500/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 max-w-4xl mx-auto shadow-lg dark:shadow-2xl relative overflow-hidden transition-theme">
            <div className="absolute top-0 right-0 p-4 sm:p-6 opacity-[0.03] dark:opacity-10 pointer-events-none transition-theme">
              <CheckSquare className="w-24 h-24 sm:w-32 sm:h-32 text-purple-600 dark:text-purple-400" />
            </div>
            <h3 className="text-xl sm:text-2xl font-extrabold mb-6 sm:mb-8 text-text-primary transition-theme">What a Fractional Scout does in a week (15 hrs example):</h3>
              ...
              {[
                ...
                'Qualifying replies and passing warm leads (SQLs) to the CRM.'
                 ...
                 <li key={idx} className="flex items-start gap-3 sm:gap-4">
                    <CheckCircle2 className="w-5 h-5 sm:w-6 sm:h-6 text-indigo-600 dark:text-indigo-400 shrink-0 mt-0.5" />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div 
              ...
              className={`bg-background-secondary border ${selectedTier === 'validation' ? 'border-purple-500 shadow-xl dark:shadow-[0_0_30px_rgba(147,51,234,0.3)]' : 'border-border-primary hover:border-purple-400 shadow-md dark:shadow-none'} rounded-2xl sm:rounded-3xl p-6 sm:p-8 cursor-pointer transition-theme flex flex-col group`}
            >
              <div className="mb-6 sm:mb-8">
                ...
                <div className="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-500 dark:from-purple-400 dark:to-indigo-400">
              ...
              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-grow">
                <li className="flex items-start gap-2.5 sm:gap-3">
                  <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 dark:text-purple-500 shrink-0 mt-0.5" />
                  <div>
                ...
                <li className="flex items-start gap-2.5 sm:gap-3">
                  <Server className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 dark:text-purple-500 shrink-0 mt-0.5" />
                  <div>
                ...
                <li className="flex items-start gap-2.5 sm:gap-3">
                  <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 dark:text-purple-500 shrink-0 mt-0.5" />
                  <div>
              ...
              <button className={`w-full py-3 sm:py-4 rounded-xl font-bold tracking-wide transition-all text-sm sm:text-base ${selectedTier === 'validation' ? 'bg-purple-600 text-white shadow-md' : 'bg-background-primary text-text-primary border border-border-primary hover:bg-background-surface'}`}>
                Select
              </button>
            </div>
            ...
            >
              ...
              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-grow relative z-10">
                ...
                <li className="flex items-start gap-2.5 sm:gap-3">
                  <Users className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 dark:text-purple-500 shrink-0 mt-0.5" />
                  <div>
                    <span className="text-xs sm:text-sm font-bold text-text-primary block transition-theme">Outreach Channels</span>
        ...
        <div className="relative max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-background-primary/90 backdrop-blur-2xl border border-border-primary p-6 sm:p-8 md:p-12 rounded-2xl sm:rounded-3xl shadow-xl dark:shadow-2xl relative z-10 transition-theme">
            <div className="text-center mb-8 sm:mb-10">
              ...
              <p className="text-sm sm:text-base text-text-secondary font-medium transition-theme">Get a pricing breakdown for the first 2 weeks of your part-time Scout engagement.</p>
            </div>
