...
const qaImg = `${s3Url}/call-recording-qa/hero.jpg`;
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              <div className="w-full h-32 sm:h-40 md:h-48 mb-6 sm:mb-8 relative flex items-center justify-center drop-shadow-lg group-hover:scale-110 group-hover:-translate-y-2 group-hover:drop-shadow-[0_20px_20px_rgba(147,51,234,0.2)] transition-all duration-500">
                <Image 
                  src={`${s3Url}/call-recording-qa/icon_capture.png`} 
            ...
            >
              <div className="w-full h-32 sm:h-40 md:h-48 mb-6 sm:mb-8 relative flex items-center justify-center drop-shadow-lg group-hover:scale-110 group-hover:-translate-y-2 group-hover:drop-shadow-[0_20px_20px_rgba(147,51,234,0.2)] transition-all duration-500">
                <Image 
                  src={`${s3Url}/call-recording-qa/icon_scoring.png`} 
                  alt="AI Scoring" 
                  fill
                  quality={75}
                  sizes="(max-width: 768px) 100vw, 33vw"
            ...
            >
              <div className="w-full h-32 sm:h-40 md:h-48 mb-6 sm:mb-8 relative flex items-center justify-center drop-shadow-lg group-hover:scale-110 group-hover:-translate-y-2 group-hover:drop-shadow-[0_20px_20px_rgba(147,51,234,0.2)] transition-all duration-500">
                <Image 
                  src={`${s3Url}/call-recording-qa/icon_coach.png`} 
                  alt="Coach at Scale" 
                  fill
                  quality={75}
                  sizes="(max-width: 768px) 100vw, 33vw"
